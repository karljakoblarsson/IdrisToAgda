...
program may be more easily proved in Agda. %TODO remove ref to bidirectional
...
%TODO remove all refs to bidirectional
...
% TODO "not possible" is bad writing. Not implemented yet and impossible.
...
translation hard. 
% TODO redo this sentence. The question is what it means and not mean if both
% programs type check.
...
% TODO Kriteriet for att oversatta eller inte ar inte om det ar latt eller
...
% TODO refer direcetly to SDP which is a part of IdrisLibs.
