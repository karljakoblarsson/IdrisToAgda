...
% Agda's development started as research in how to implement dependent types.
% Idris is designed to be similar to Haskell syntactically.
...
Idris implementation of vector concatenation: %in listing~\ref{lst:hole1}.
...
% TODO These to paragraphs should be fixed and merged and spilt to three maybe
