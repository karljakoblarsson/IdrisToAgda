...
% TODO Use the standard structure in the thesis template.

% TODO Include a updated time plan in the end.

% TODO Look at the refactoring thesis again and try to emulate parts of it.

% TODO Start more general, then zoom in to my topic.
...
\subsection{Goals}
% TODO Talk about that the user may have to fill in the missing parts
