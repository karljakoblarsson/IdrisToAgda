...
% TODO TODO TODO
% "Future:"
% Then we ran this tool on the 'IdrisLibs' Sequantial Decision
% Problems library. See the results in figure. Right now the transpiler handles
...
% \item The transpiler passes many generated tests.
...
% state, It is almost like an imperative program, just written in Haskell. The
