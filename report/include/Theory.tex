...
\reviewer{Well, you don't know that, since that is not what you are
investigating.}
...
$p$.  Developing a formal correctness proof is an huge\reviewer{UA}
undertaking, there exists only a handful of formally verified compilers
published.
\reviewer{2, as far as I'm aware, CakeML and CompCert (apart from toy
compilers). Good place to add citations.}
