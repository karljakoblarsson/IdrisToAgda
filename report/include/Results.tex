...
compiler.
\reviewer{I know this isn't done, but for future reference: Start with a high level overview, focusing on what it can do, and then what targets you didn't hit. The exact reasons why can be discussed later.}
...
relevant for this project.\reviewer{Try to keep it specific, don't be too ``fluffy''.}
...
work in a new folder structure.\todo{Update to current progress}\reviewer{Again, this needs to come late, don't open with what you can't do.}
...
able to compile substantial programs.\reviewer{Vague. Say what programs work, and which don't.} Therefore it is hard to test the
transpiler thoroughly.\reviewer{What makes it hard? You mean you have to write your own tests, you can't just use a lot of existing code? It would be hard to test regardless, since you need to fill in holes manually, right?}\todo{This is not true. It handles large programs just
