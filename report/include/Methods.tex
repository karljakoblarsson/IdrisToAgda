...
\froall n <= m$. Universe levels in Idris are always infered by the compiler,
...
\lstinlin{Type}. However, this will not have correct semantics, it is entierly
