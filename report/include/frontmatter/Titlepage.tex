...
{\Large Jakob Larsson} \setlength{\parskip}{2.9cm}
...
\oneLineTitle\\
\oneLineSubtitle\\
Jakob Larsson \setlength{\parskip}{1cm}

\copyright ~ Jakob Larsson, \the\year. \setlength{\parskip}{1cm}

Supervisor: Patrik Jansson, Department of Computer Science and Engineering\\
% Advisor: Name, Company or Institute (if applicable)\\
Examiner: Nils-Anders Danielsson, Department of Computer Science and Engineering\setlength{\parskip}{1cm}
