...
-- TODO This (a : Set) thing and the {a b : N}. Is the only thing left for this
   example. Something about implicit/explicit arguments which I don't understand
   fully. Especially in Agda.
