      ...
      [Arg {
        argInfo = ArgInfo {
          ...
          argInfoModality = Modality {
            modRelevance = Relevant,
            modQuantity = Quantityω
            },
